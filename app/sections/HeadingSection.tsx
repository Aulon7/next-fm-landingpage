    ...
    >
      <motion.div {...fadeInFromTop} className="md:w-[478px] px-10">
        ...
        <p className="section-paragraph md:text-left">
          ...
          platform built to guide your journey — track your property goals, stay
          motivated through expert insights, and celebrate every successful step
          toward your dream home or investment
        </p>
